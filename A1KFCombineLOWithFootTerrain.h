...
/* 
    ...
    opti_observation = [pos, vel, euler]
                       [0:2, 3:5, 6:8]
*/
...
#define OPTI_OBSERVATION_SIZE 9 // observe position, velocity, and euler angles using optitrack
...
class A1KFCombineLOWithFootTerrain : public A1KF {
    public:
        ...
        void set_noise_params(double _inital_cov = 0.01,
                              ...
                              double _noise_opti_roll = 0.01,
                              double _noise_opti_pitch = 0.01,
    ...
    private:
        ...
        double noise_opti_roll = 0.01;
        double noise_opti_pitch = 0.01;
