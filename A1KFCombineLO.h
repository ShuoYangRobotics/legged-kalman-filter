...
class A1KFCombineLO : public A1KF {
    ...
    private:
        ...
        // Eigen::Matrix<double, STATE_SIZE, STATE_SIZE> process_jac(Eigen::Matrix<double, STATE_SIZE, 1> state, 
        //                                              Eigen::Matrix<double, CONTROL_SIZE, 1> prev_ctrl, 
        //                                              Eigen::Matrix<double, CONTROL_SIZE, 1> ctrl, double dt);
        ...
        // Eigen::Matrix<double, OBSERVATION_SIZE, STATE_SIZE> meas_jac(Eigen::Matrix<double, STATE_SIZE, 1> state, 
        //                                              Eigen::Matrix<double, 3, 1> w, 
        //                                              Eigen::Matrix<double, 12, 1> joint_ang, 
        //                                              Eigen::Matrix<double, 12, 1> joint_vel,
        //                                              Eigen::Matrix<double, 4, 1> contact);
